...
* **Upload Foto Bukti**: Mendukung upload hingga 3 foto sekaligus (JPG, JPEG, PNG, WEBP, HEIC) dengan pratinjau instan.
...
* **Halaman Tugas Petugas**: Petugas hanya melihat laporan yang ditugaskan kepadanya melalui halaman *Tugas Saya*.
...
**1. Administrator** *(Bisa melihat semua data, export, disposisi, kelola petugas)*
...
* `app/Services` → *Business logic* (upload file, generate tiket, WhatsApp notif)
